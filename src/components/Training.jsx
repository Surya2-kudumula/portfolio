    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="mt-5">
                    <h3 className="text-white font-bold text-[24px] hover:text-primary transition-colors">
                        {name}
                    </h3>
...
const Training = () => {
    return (
        <>
            ...
            >
                These certifications reflect my commitment to continuous learning. From mastering Android development and C++ to diving deep into algorithms, each step has enhanced my technical expertise and practical problem-solving capabilities.
            </motion.div>
