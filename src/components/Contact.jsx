    ...
    emailjs
      .send(
...

        {
          ...
          to_email: "suryakudumula29@gmail.com",
    ...
    <>
      ...
      <div className="w-full flex flex-col items-center justify-center mt-10">
        ...
        <div className="flex gap-6">
          <a
            href="https://github.com/kudumulasurya"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://www.linkedin.com/in/kudumulasurya/"
            target="_blank"
            rel="noreferrer"
            className="text-white text-3xl hover:text-purple-500 transition"
          >
